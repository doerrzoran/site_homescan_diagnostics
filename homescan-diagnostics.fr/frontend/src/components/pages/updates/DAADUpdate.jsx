...
import { useUpdateDAADMutation } from "../../../slices/UpdateSlice";

export default function DAADUpdate() {
    const { data, loading } = useGetPreDestructionAsbestosQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateDAADMutation()
