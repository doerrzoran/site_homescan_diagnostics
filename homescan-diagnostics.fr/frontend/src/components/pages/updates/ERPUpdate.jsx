...
import { useGetERPQuery } from "../../../slices/ApiSlice";
import { useUpdateERPMutation } from "../../../slices/UpdateSlice";

export default function ERPUpdate() {
    const { data, loading } = useGetERPQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateERPMutation()
