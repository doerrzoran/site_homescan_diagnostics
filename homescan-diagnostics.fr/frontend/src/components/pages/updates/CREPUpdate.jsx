...
import { useUpdateCrepMutation } from "../../../slices/UpdateSlice";

export default function CREPUpdate() {
    const { data, loading } = useGetLeadQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updateCREPage, { isLoading, isError }] = useUpdateCrepMutation()
