...
import { useUpdateDPATMutation } from "../../../slices/UpdateSlice";

export default function DPATUpdate() {
    const { data, loading } = useGetPreConstructionLeadQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateDPATMutation()
