...
import { useUpdateDPADMutation } from "../../../slices/UpdateSlice";

export default function DPADUpdate() {
    const { data, loading } = useGetPreDestructionQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateDPADMutation()
