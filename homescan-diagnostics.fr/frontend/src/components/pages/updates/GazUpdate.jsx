...
import { useUpdateGazMutation } from "../../../slices/UpdateSlice";

export default function GazUpdate() {
    const { data, loading } = useGetGazQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateGazMutation()
