...
import { useGetEnergyQuery } from "../../../slices/ApiSlice";
import { useUpdateEnergyMutation } from "../../../slices/UpdateSlice";

export default function EnergyUpdate() {
    const { data, loading } = useGetEnergyQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateEnergyMutation()
  ...
  return (
    ...
    <div>
        <h2>modifier la page energie</h2>
