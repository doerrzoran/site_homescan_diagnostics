...
import { useUpdateDTADMutation } from "../../../slices/UpdateSlice";

export default function DTADUpdate() {
    const { data, loading } = useGetPreDestructionTermitesQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateDTADMutation()
