...
import { useUpdateDTATMutation } from "../../../slices/UpdateSlice";

export default function DTATUpdate() {
    const { data, loading } = useGetPreConstructionTermitesQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updatePage, { isLoading, isError }] = useUpdateDTATMutation()
