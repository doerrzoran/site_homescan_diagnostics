...
import { useUpdateAsbestosMutation } from "../../../slices/UpdateSlice";

export default function AsbestosUpdate() {
    const { data, loading } = useGetAsbestosQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updateAsbestosPage, { isLoading, isError }] = useUpdateAsbestosMutation()
