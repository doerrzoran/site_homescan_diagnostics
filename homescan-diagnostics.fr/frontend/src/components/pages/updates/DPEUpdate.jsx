...
import { useGetDPEQuery } from "../../../slices/ApiSlice";
import { useUpdateDPEMutation } from "../../../slices/UpdateSlice";

export default function DPEUpdate() {
    const { data, loading } = useGetDPEQuery()
    const [newTitle, setNewTitle] = useState(data?.title ?? '')
    const [newText, setNewText] = useState(data?.text ?? '')
    const [updateDPEPage, { isLoading, isError }] = useUpdateDPEMutation()
