...
class ElectricityUpdateController extends AbstractController
{
    #[Route('/electricity/update', name: 'app_electricity_update')]
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $entity = $entityManager->getRepository(Electricity::class)->find(1);
