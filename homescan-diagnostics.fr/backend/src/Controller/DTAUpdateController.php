...
class DTAUpdateController extends AbstractController
{
    #[Route('/d/t/a/update', name: 'app_d_t_a_update', methods: ['POST'])]
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $dta = $entityManager->getRepository(DTA::class)->find(1);
