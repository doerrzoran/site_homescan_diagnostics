...
class EnergyUpdateController extends AbstractController
{
    #[Route('/energy/update', name: 'app_energy_update')]
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $entity = $entityManager->getRepository(Energy::class)->find(1);
