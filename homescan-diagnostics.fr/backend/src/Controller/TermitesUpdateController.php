...
class TermitesUpdateController extends AbstractController
{
    #[Route('/termites/update', name: 'app_termites_update')]
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $entity = $entityManager->getRepository(Termites::class)->find(1);
