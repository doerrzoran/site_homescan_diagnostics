...
class CarrezUpdateController extends AbstractController
{
    #[Route('/carrez/update', name: 'app_carrez_update')]
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $entity = $entityManager->getRepository(Carrez::class)->find(1);
