...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($container->privates['.service_locator.yZnLB1s'] ?? self::get_ServiceLocator_YZnLB1sService($container)), new RewindableGenerator(function () use ($container) {
