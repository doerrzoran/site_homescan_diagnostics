 ...
 */
class getElectricityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ElectricityRepository' shared autowired service.
     *
     * @return \App\Repository\ElectricityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ElectricityRepository.php';

        return $container->privates['App\\Repository\\ElectricityRepository'] = new \App\Repository\ElectricityRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
