 ...
 */
class getDAADRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DAADRepository' shared autowired service.
     *
     * @return \App\Repository\DAADRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DAADRepository.php';

        return $container->privates['App\\Repository\\DAADRepository'] = new \App\Repository\DAADRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
