 ...
 */
class getCREPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CREPRepository' shared autowired service.
     *
     * @return \App\Repository\CREPRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CREPRepository.php';

        return $container->privates['App\\Repository\\CREPRepository'] = new \App\Repository\CREPRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
