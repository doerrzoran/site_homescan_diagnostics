 ...
 */
class getDTARepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DTARepository' shared autowired service.
     *
     * @return \App\Repository\DTARepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DTARepository.php';

        return $container->privates['App\\Repository\\DTARepository'] = new \App\Repository\DTARepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
