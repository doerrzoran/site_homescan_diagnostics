...
class getMissionsRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MissionsRepository.php';

        return $container->privates['App\\Repository\\MissionsRepository'] = new \App\Repository\MissionsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
