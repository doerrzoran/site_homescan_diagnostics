 ...
 */
class getERPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ERPRepository' shared autowired service.
     *
     * @return \App\Repository\ERPRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ERPRepository.php';

        return $container->privates['App\\Repository\\ERPRepository'] = new \App\Repository\ERPRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
