 ...
 */
class getDPERepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DPERepository' shared autowired service.
     *
     * @return \App\Repository\DPERepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DPERepository.php';

        return $container->privates['App\\Repository\\DPERepository'] = new \App\Repository\DPERepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
