 ...
 */
class getDPADRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DPADRepository' shared autowired service.
     *
     * @return \App\Repository\DPADRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DPADRepository.php';

        return $container->privates['App\\Repository\\DPADRepository'] = new \App\Repository\DPADRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
