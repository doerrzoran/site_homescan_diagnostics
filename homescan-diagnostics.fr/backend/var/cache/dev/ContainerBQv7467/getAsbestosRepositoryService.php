 ...
 */
class getAsbestosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AsbestosRepository' shared autowired service.
     *
     * @return \App\Repository\AsbestosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AsbestosRepository.php';

        return $container->privates['App\\Repository\\AsbestosRepository'] = new \App\Repository\AsbestosRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
