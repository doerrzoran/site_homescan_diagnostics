 ...
 */
class getSocietyRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SocietyRepository.php';

        return $container->privates['App\\Repository\\SocietyRepository'] = new \App\Repository\SocietyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
