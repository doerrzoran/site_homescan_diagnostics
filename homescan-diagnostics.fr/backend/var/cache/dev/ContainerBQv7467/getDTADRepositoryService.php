 ...
 */
class getDTADRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DTADRepository' shared autowired service.
     *
     * @return \App\Repository\DTADRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DTADRepository.php';

        return $container->privates['App\\Repository\\DTADRepository'] = new \App\Repository\DTADRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
