 ...
 */
class getEstimateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EstimateRepository' shared autowired service.
     *
     * @return \App\Repository\EstimateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EstimateRepository.php';

        return $container->privates['App\\Repository\\EstimateRepository'] = new \App\Repository\EstimateRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
