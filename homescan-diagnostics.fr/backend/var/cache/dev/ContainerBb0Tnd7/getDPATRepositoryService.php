 ...
 */
class getDPATRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DPATRepository' shared autowired service.
     *
     * @return \App\Repository\DPATRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DPATRepository.php';

        return $container->privates['App\\Repository\\DPATRepository'] = new \App\Repository\DPATRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
