 ...
 */
class getInterventionSectorsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InterventionSectorsRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionSectorsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InterventionSectorsRepository.php';

        return $container->privates['App\\Repository\\InterventionSectorsRepository'] = new \App\Repository\InterventionSectorsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
