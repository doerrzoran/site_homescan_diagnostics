...
class getHomePageRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HomePageRepository.php';

        return $container->privates['App\\Repository\\HomePageRepository'] = new \App\Repository\HomePageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
