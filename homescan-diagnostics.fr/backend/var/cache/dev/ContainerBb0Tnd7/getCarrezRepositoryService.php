 ...
 */
class getCarrezRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarrezRepository' shared autowired service.
     *
     * @return \App\Repository\CarrezRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarrezRepository.php';

        return $container->privates['App\\Repository\\CarrezRepository'] = new \App\Repository\CarrezRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
