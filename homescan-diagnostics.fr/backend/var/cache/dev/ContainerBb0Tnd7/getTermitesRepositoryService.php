 ...
 */
class getTermitesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TermitesRepository' shared autowired service.
     *
     * @return \App\Repository\TermitesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TermitesRepository.php';

        return $container->privates['App\\Repository\\TermitesRepository'] = new \App\Repository\TermitesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
