 ...
 */
class getRAATRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RAATRepository' shared autowired service.
     *
     * @return \App\Repository\RAATRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RAATRepository.php';

        return $container->privates['App\\Repository\\RAATRepository'] = new \App\Repository\RAATRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
