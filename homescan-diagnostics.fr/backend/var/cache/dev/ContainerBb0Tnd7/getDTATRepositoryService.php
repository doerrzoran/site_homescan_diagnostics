 ...
 */
class getDTATRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DTATRepository' shared autowired service.
     *
     * @return \App\Repository\DTATRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DTATRepository.php';

        return $container->privates['App\\Repository\\DTATRepository'] = new \App\Repository\DTATRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
